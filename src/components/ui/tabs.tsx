...
function TabsTrigger({
  ...
  style,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.Trigger> & { activeBg?: string }) {
  const mergedStyle = activeBg
    ? { ...style, ['--tabs-active-bg' as string]: activeBg }
    : style;
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        !activeBg && "data-[state=active]:bg-background dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30",

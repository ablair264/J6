...
export const COMPONENTS: ComponentInfo[] = [
    ...
    },
    {
        ...
        summary: 'Container with header, content, and footer sections.',
    },
    {
        kind: 'checkbox',
        label: 'Checkbox',
...
export const CARD_VISUAL_PRESETS: ComponentVisualPreset[] = [
    ...buildVisualPresetsForKind('card', {
        soft: {
            label: 'Elevated',
            description: 'Subtle gradient with lift shadow — clean product card feel.',
            values: {
                fillMode: 'gradient',
                fillColor: '#f1f5f9',
                fillColorTo: '#e2e8f0',
        ...
        glass: {
            label: 'Frosted',
            description: 'Glassmorphic card with blur and translucency.',
            values: {
                fillMode: 'solid',
                fillColor: '#f8fafc',
                fillOpacity: 18,
        ...
        contrast: {
            label: 'Dark Surface',
            description: 'Dark elevated card with accent glow — vehicle/product showcase.',
            values: {
                fillMode: 'solid',
                fillColor: '#0f172a',
                fillOpacity: 100,
        ...
        brand: {
            label: 'Accent Glow',
            description: 'Dark card with neon accent border — hero feature card.',
            values: {
                fillMode: 'solid',
                fillColor: '#0b1220',
                fillOpacity: 100,
        ...
        sunset: {
            label: 'Warm Gradient',
            description: 'Warm gradient card with border beam — attention-grabbing CTA.',
            values: {
                fillMode: 'gradient',
                fillColor: '#1e1028',
                fillColorTo: '#1a0a1e',
                ...
                effectBorderBeamColorFrom: '#fb7185',
                effectBorderBeamColorTo: '#f59e0b',
    ...
    // Extra card-only presets
    {
        id: 'minimal',
        label: 'Minimal',
        description: 'Clean white card — e-commerce product listing style.',
        kind: 'card',
        values: {
    ...
    },
    {
        id: 'tilt-3d',
        label: 'Tilt 3D',
        description: 'Interactive 3D tilt with glare on hover — premium showcase.',
        kind: 'card',
        values: {
            componentPreset: 'tilt-3d',
            fillMode: 'gradient',
            fillColor: '#0f172a',
            fillColorTo: '#1e1b4b',
            fillWeight: 60,
            ...
            fontColor: '#e0e7ff',
            effectDropShadow: true,
            dropShadowStrength: 45,
            cardShowHeader: true,
            cardShowFooter: true,
            cardShowDividers: false,
            cardVariant: 'elevated',
            motionHoverTiltEnabled: true,
            motionHoverTiltStrength: 12,
            motionHoverGlareEnabled: true,
            motionHoverGlareColor: '#818cf8',
            motionHoverGlareOpacity: 0.15,
        },
    },
];

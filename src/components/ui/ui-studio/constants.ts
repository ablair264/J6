...
export const DEFAULT_STYLE: ComponentStyleConfig = {
    ...
    popoverTitleText: 'Popover preview',
    popoverBodyText: 'Styled from the side controls.',
    popoverActionLabel: 'Open report',
    popoverItemOneLabel: 'Daily digest',
    popoverItemTwoLabel: 'Auto-assign reviews',
    popoverItemTwoValue: 'On',
    ...
    alertDescription: 'This is an alert message with relevant details.',
    alertActionMode: 'none',
    alertPrimaryLabel: 'Confirm',
    alertSecondaryLabel: 'Cancel',
    // Card (shared)
    cardVariant: 'default',
    cardShowImage: false,
    cardShowHeader: true,
...
export const POPOVER_VISUAL_PRESETS: ComponentVisualPreset[] = [
    ...
    },
    {
        ...
        description: 'Amber status summary with a single report action',
        kind: 'popover',
        values: {
            popoverSide: 'bottom',
            popoverAlign: 'start',
            popoverContentVariant: 'snapshot',
            fillMode: 'solid',
            fillColor: '#f6b84a',
            fillOpacity: 100,
            fontColor: '#161618',
            ...
            panelStrokeOpacity: 80,
            panelCornerRadius: 18,
            panelFontColor: '#f5e6cf',
            popoverTitleText: 'Migration snapshot',
            popoverBodyText: '24 components updated, 3 tokens renamed, and no visual regressions detected in the last pass.',
            popoverActionLabel: 'Open report',
        },
    },
    {
        ...
        description: 'Violet utility panel with settings rows',
        kind: 'popover',
        values: {
            popoverSide: 'right',
            popoverAlign: 'start',
            popoverContentVariant: 'automation',
            fillMode: 'gradient',
            fillColor: '#7c3aed',
            fillColorTo: '#a855f7',
            fillOpacity: 100,
            ...
            grainOpacity: 20,
            grainSize: 200,
            panelFillColor: '#10071f',
            panelFillOpacity: 100,
            panelStrokeColor: '#5b21b6',
            panelStrokeOpacity: 70,
            panelCornerRadius: 18,
            panelFontColor: '#f5f3ff',
            popoverTitleText: 'Automation',
            popoverBodyText: 'Keep approvals on, send daily summaries, and surface only high-signal alerts.',
            popoverItemOneLabel: 'Daily digest',
            popoverItemTwoLabel: 'Auto-assign reviews',
            popoverItemTwoValue: 'On',
        },
    },
    {
        id: 'profile-menu',
        label: 'Profile Menu',
        description: 'User profile card with navigation menu items',
        kind: 'popover',
        values: {
            popoverSide: 'bottom',
            popoverAlign: 'end',
            popoverContentVariant: 'profile',
            panelFillColor: '#1a1a2e',
            panelFillOpacity: 100,
            panelStrokeColor: '#475569',
            panelStrokeOpacity: 25,
...
const ALERT_VISUAL_PRESETS: ComponentVisualPreset[] = [
    {
        ...
        description: 'Dual-action security prompt.',
        kind: 'alert',
        values: {
            componentPreset: 'security-update',
            alertVariant: 'success',
            alertTitle: 'Security Update',
            alertDescription: 'Update your password and enable 2FA to keep your account secure.',
            alertActionMode: 'double',
            alertPrimaryLabel: 'Update',
            alertSecondaryLabel: 'Dismiss',
        },
    },
    {
        id: 'payment-failed',
        ...
        values: {
            ...
            alertDescription: 'Your payment could not be processed. Please check your card details and try again.',
            alertActionMode: 'single',
            alertPrimaryLabel: 'Retry Payment',
            fillMode: 'solid',
            fillColor: '#3b0d0f',
            fillOpacity: 96,
            strokeColor: '#7f1d1d',
    ...
    },
    {
        ...
        values: {
            ...
            alertDescription: 'Our systems will be briefly unavailable on Saturday from 2-4am UTC.',
            alertActionMode: 'none',
        },
    },
    {
    ...
    },
    {
        id: 'ops-warning',
        label: 'Ops Warning',
        description: 'Warning alert with action button.',
        kind: 'alert',
        values: {
            componentPreset: 'ops-warning',
            alertVariant: 'warning',
            alertTitle: 'API Latency Warning',
            alertDescription: 'Increased latency detected in US-East regions. Our engineers are investigating.',
            alertActionMode: 'single',
            alertPrimaryLabel: 'View Status',
        },
    },
    {
        id: 'destructive-confirm',
        label: 'Destructive Confirm',
        description: 'Error alert with confirm/cancel actions.',
        kind: 'alert',
        values: {
            componentPreset: 'destructive-confirm',
            alertVariant: 'error',
            alertTitle: 'Delete Account',
            alertDescription: 'This action is permanent and cannot be undone. All your data will be lost.',
            alertActionMode: 'double',
            alertPrimaryLabel: 'Delete',
            alertSecondaryLabel: 'Cancel',

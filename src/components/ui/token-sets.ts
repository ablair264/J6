...
export const SYSTEM_TOKEN_SET: StudioTokenSet = {
  ...
  source: 'system',
  tokens: [
    { id: 'primary', label: 'Primary', value: '#4daebc', cssVar: '--primary' },
    { id: 'secondary', label: 'Secondary', value: '#f1f5f9', cssVar: '--secondary' },
    { id: 'accent', label: 'Accent', value: '#e0f7fa', cssVar: '--accent' },
    { id: 'muted', label: 'Muted', value: '#f1f5f9', cssVar: '--muted' },
    { id: 'foreground', label: 'Foreground', value: '#0f1419', cssVar: '--foreground' },
    { id: 'background', label: 'Background', value: '#ffffff', cssVar: '--background' },
    { id: 'border', label: 'Border', value: '#d8dee8', cssVar: '--border' },
    { id: 'input', label: 'Input', value: '#e2e8f0', cssVar: '--input' },
    { id: 'ring', label: 'Ring', value: '#4daebc', cssVar: '--ring' },
    { id: 'success', label: 'Success', value: '#10b981', cssVar: '--success' },
    { id: 'warning', label: 'Warning', value: '#f59e0b', cssVar: '--warning' },
    { id: 'info', label: 'Info', value: '#3b82f6', cssVar: '--info' },
    { id: 'destructive', label: 'Destructive', value: '#ef4444', cssVar: '--destructive' },
    { id: 'chart-1', label: 'Chart 1', value: '#f97316', cssVar: '--chart-1' },
    { id: 'chart-2', label: 'Chart 2', value: '#06b6d4', cssVar: '--chart-2' },
    { id: 'chart-3', label: 'Chart 3', value: '#2563eb', cssVar: '--chart-3' },
  ],
  sizeTokens: {
    sm: { height: 34 },
    md: { height: 38 },

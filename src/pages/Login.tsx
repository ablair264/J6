...
export default function Login() {
  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center bg-gradient-to-br from-[#0f1419] via-[#1a1f2a] to-[#2c3e50] font-sans p-4 overflow-hidden">
      ...
      {/* Radial overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_40%,rgba(121,213,233,0.12)_0%,transparent_40%),radial-gradient(ellipse_at_70%_60%,rgba(77,174,172,0.08)_0%,transparent_50%)] pointer-events-none z-[1]" />

      {/* Floating accent blob */}
      <div className="absolute top-[20%] right-[15%] w-[clamp(200px,30vw,300px)] h-[clamp(200px,30vw,300px)] bg-[radial-gradient(circle,rgba(121,213,233,0.1)_0%,rgba(121,213,233,0.05)_50%,transparent_100%)] rounded-full blur-[40px] animate-[gentle-float_6s_ease-in-out_infinite] pointer-events-none z-[3] max-sm:hidden" />
      ...
      <div className="relative z-10 w-full max-w-[400px] md:max-w-[440px] lg:max-w-[480px]">
        <div className="bg-[rgba(26,31,42,0.95)] backdrop-blur-xl border-2 border-[rgba(121,213,233,0.2)] rounded-2xl p-8 lg:p-10 shadow-[0_25px_50px_rgba(0,0,0,0.5),0_0_40px_rgba(121,213,233,0.1)] transition-shadow duration-300 hover:shadow-[0_25px_50px_rgba(0,0,0,0.5),0_0_60px_rgba(121,213,233,0.15)]">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-1">
            {error && (
              <div className="flex items-center gap-3 p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-sm font-medium mb-4 backdrop-blur-sm animate-[error-slide-in_0.3s_ease_forwards]">
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-xs text-[rgba(148,163,184,0.7)] leading-relaxed">
              Don't have an account?{' '}
              <Link to="/register" className="text-[rgba(121,213,233,0.9)] hover:text-[rgba(121,213,233,1)] hover:underline transition-colors font-medium">
                Create one
              </Link>
            </p>
          </div>
